...
from utils.dataset import Datasetimport os
import tqdm
import numpy as np
from torchsummary import summary
...
from torchvision.models import resnet101     # ✅ ResNet50 → ResNet101로 교체
from utils.loss import yoloLoss
...
def main(args):
    ...
    net = YOLOv1_ResNet(num_classes=20, S=7, B=2)
    ...
    criterion = yoloLoss(S=7, B=2, num_class=20).to(device)
    net = net.to(device)
